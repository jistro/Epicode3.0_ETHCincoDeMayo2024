...
contract SenderReceiverARB is AxelarExecutable {
    ...
    /**
     *  @notice Este método envia un mensaje a la red de destino en este caso Avalanche.
    ...
    function sendMessage(
        ...
        gateway.callContract("Avalanche",destinationAddress,payload);
    }
